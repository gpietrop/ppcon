...
from ppcon.train.train import Conv1dMed
from ppcon.train.train import MLPDay, MLPYear, MLPLon, MLPLat

from ppcon.dict import dict_max_pressure, dict_interval
